  ...
  <div class="page animsition">
    <div class="page-content">
      ...
      <div class="example example-buttons">
                  <div align="center">
                    <a href=""><button type="button" class="btn btn-round btn-primary btn-pill-left waves-effect waves-round waves-light">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INFORMATIKA &nbsp; &nbsp; &nbsp; &nbsp; </button></a>
                    <a href=""><button type="button" class="btn btn-round btn-primary btn-pill-right waves-effect waves-round waves-light">MANAJEMEN INFORMATIKA</button></a>
                  </div>
      </div>
      <div class="panel">
