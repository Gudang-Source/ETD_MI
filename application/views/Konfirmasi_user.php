...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">User Belum Diverifikasi</h1>
              ...
              <?php
               ...
               ?>
                <tr>
                  ...
                  <td><?php echo $judul->no_hp; ?></td>
                  <td><?php echo $judul->email; ?></td>
                  <td><?php echo $judul->alamat; ?></td>


                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."konfirmasi/user_ya?id=".$judul->npm."'>
                  <button type='button' class='btn btn-success'>Konfirmasi</button></a>
                    </td>";
                  ?>
                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."konfirmasi/user_no?id=".$judul->npm."'>
                  <button type='button' class='btn btn-danger'>Batalkan</button></a>
                    </td>";
                  ?>
