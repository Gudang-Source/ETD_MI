...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jan 2018 pada 11.37
...
--
-- Struktur dari tabel `bidang_minat`
--
...
--
-- Dumping data untuk tabel `bidang_minat`
--
...
--
-- Dumping data untuk tabel `bimbing`
--
...
--
ALTER TABLE `bidang_minat`
  MODIFY `id_bidang_minat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `bimbing`
--
ALTER TABLE `bimbing`
  MODIFY `id_bimbing` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
...
--
ALTER TABLE `ta`
  MODIFY `id_tugas_akhir` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;COMMIT;
